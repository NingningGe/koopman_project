...
noise_velocities = np.concatenate([np.random.uniform(-0.3,0.3,5),[0,0,0,0,0,0]])
my_dofbot.set_joint_velocities(noise_velocities)

segment_counter = 0  

while (time.time() - start_time2) < 500:
    A1,A2,A3,A4,A5 = np.random.uniform(0,0.3,5)
    ...
    if (time.time() - start_time) <= 1:
        ...
        noise_std = [0.06, 0.06,0.06,0.06,0.06,0,0,0,0,0,0]
        noisy_speeds = [
...
np.save('/home/cxf/franka/traj_speed_file/all_segment_testdata2_dofbot.npy', segment_data)
