...
def plot(test_data,udim):
    ...
    if udim==7:
        ...
        show(grid)
def main():
    test_data = np.load('/home/ccr/project-koopman/model_transfer_robot/speed_traj_data/traj_train_file/test_data1_franka.npy')
    plot(test_data,7)
    test_data = np.load('/home/ccr/project-koopman/model_transfer_robot/speed_traj_data/traj_train_file/test_data2_franka.npy')
    plot(test_data,7)
    test_data = np.load('/home/ccr/project-koopman/model_transfer_robot/speed_traj_data/traj_train_file/test_data3_franka.npy')
    plot(test_data,7)
    test_data = np.load('/home/ccr/project-koopman/model_transfer_robot/speed_traj_data/traj_train_file/test_data4_franka.npy')
    plot(test_data,7)
