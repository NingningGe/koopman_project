...
import os
suffix = "enc_test2"
if not os.path.exists("/home/nng/unified_represention/franka/traj/photo/" + suffix):
    os.makedirs("/home/nng/unified_represention/franka/traj/photo/" + suffix)

output_file("/home/nng/unified_represention/franka/traj/photo/" + suffix + "/1.html")
