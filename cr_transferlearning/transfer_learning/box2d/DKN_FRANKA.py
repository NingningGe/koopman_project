...
class Network(nn.Module):
    def __init__(self, encode_layers, bilinear_layers, Nkoopman, u_dim):
        ...
        self.lB = nn.Linear(bilinear_layers[-1]+u_dim, Nkoopman, bias=False)
    ...
    def bicode(self, x, u):
        ...
        return torch.cat([u, self.bilinear_net(x_all)], axis=-1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--suffix", type=str, default="DKN")
    ...
    parser.add_argument("--b_dim", type=int, default=6)
