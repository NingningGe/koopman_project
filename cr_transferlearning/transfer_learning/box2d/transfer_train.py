...
# Ktest_data2 = np.load("/home/ccr/unified_represention/transfer_learning/traj_data/traj_train_file/Ktest_data_franka.npy")
# Ktrain_data2 = np.load("/home/ccr/unified_represention/transfer_learning/traj_data/traj_train_file/Ktrain_data_franka.npy")
# Ktest_data1 = np.load("/home/ccr/unified_represention/transfer_learning/traj_data/traj_train_file/Ktest_data_ur.npy")
# Ktrain_data1 = np.load("/home/ccr/unified_represention/transfer_learning/traj_data/traj_train_file/Ktrain_data_ur.npy")
# print("Ktest_data1 shape:",Ktest_data1.shape)
# print("Ktrain_data1 shape:",Ktrain_data1.shape)
# print("Ktest_data2 shape:",Ktest_data2.shape)
# print("Ktrain_data2 shape:",Ktrain_data2.shape)
...
#
# def Klinear_loss(X1,X2,net,enc_net1,enc_net2,enc_net4,enc_net5,dec_net1,dec_net2,dec_net4,dec_net5,mse_loss,gamma,Nstate,primary_udim1,primary_udim2):
...
#         u_rec_loss += beta * (mse_loss(U1_dec, X1[i, :, :primary_udim1]) + mse_loss(U2_dec, X2[i, :, :primary_udim2]))
...
#         U_rec_loss += beta * (mse_loss(U1, U1_dec_enc) + mse_loss(U2, U2_dec_enc))
#         X1_current = net.forward(X1_current, U1)
#         X2_current = net.forward(X2_current, U2)
#         Y_loss += beta * (mse_loss(X1_current[:, :Nstate], X1_enc[i + 1, :, :])+mse_loss(X2_current[:, :Nstate], X2_enc[i + 1, :, :]))
#         X1_next = dec_net1.DEC(X1_current[:, :Nstate])
#         X2_next = dec_net2.DEC(X2_current[:, :Nstate])
#         x_loss += beta * (mse_loss(X1[i + 1, :, primary_udim1:], X1_next)+mse_loss(X2[i + 1, :, primary_udim2:], X2_next))
#         X1_next_enc = enc_net1.ENC(X1_next)
#         X2_next_enc = enc_net2.ENC(X2_next)
#         x_enc_loss += beta * (mse_loss(X1_current[:, :Nstate], X1_next_enc)+mse_loss(X2_current[:, :Nstate], X2_next_enc))
#         X1_next_enc_dec = dec_net1.DEC(X1_next_enc)
#         X2_next_enc_dec = dec_net2.DEC(X2_next_enc)
#         x_enc_dec_loss += beta * (mse_loss(X1_next_enc_dec, X1_next)+mse_loss(X2_next_enc_dec, X2_next))
#         X1_current_encoded = net.encode(X1_current[:, :Nstate])
#         X2_current_encoded = net.encode(X2_current[:, :Nstate])
#         Y_enc_loss += beta * (mse_loss(X1_current_encoded, X1_current)+mse_loss(X2_current_encoded, X2_current))
#         beta *= gamma
#     Y_loss /= beta_sum
#     x_loss /= beta_sum
#     x_enc_loss /= beta_sum
...
#     Y_enc_loss /= beta_sum
#     x_loss *= 100
#     loss = Y_loss + x_loss + x_enc_loss + u_rec_loss + U_rec_loss + x_enc_dec_loss + Y_enc_loss+cyc_loss
#     return loss, Y_loss, x_loss, x_enc_loss, u_rec_loss, U_rec_loss ,x_enc_dec_loss, Y_enc_loss,cyc_loss
#
#
...
#     eval_step = 1000
#     best_loss = 1000.0
#     logdir = "/home/ccr/unified_represention/transfer_learning/Data/Data/" + suffix + "/unified" + env_name + "layer{}_edim{}_eloss{}".format(
#         layer_depth, encode_dim, e_loss)
#     if not os.path.exists("/home/ccr/unified_represention/transfer_learning/Data/Data/" + suffix):
#         os.makedirs("/home/ccr/unified_represention/transfer_learning/Data/Data/" + suffix)
...
#         genloss.backward()
#         optimizer3.step()
#         Kloss,Y_loss, x_loss, x_enc_loss, u_rec_loss, U_rec_loss ,x_enc_dec_loss, Y_enc_loss,cyc_loss = Klinear_loss(X1,X2,net,enc_net1,enc_net2,enc_net4,enc_net5,dec_net1,dec_net2,dec_net4,dec_net5,mse_loss,gamma,Nstate,primary_udim1,primary_udim2)
#         Eloss = Eig_loss(net)
...
#             # K loss
#             with torch.no_grad():
#                 Kloss,Y_loss, x_loss, x_enc_loss, u_rec_loss, U_rec_loss ,x_enc_dec_loss, Y_enc_loss,cyc_loss = Klinear_loss(Ktest_data1,Ktest_data2,net,enc_net1,enc_net2,enc_net4,enc_net5,dec_net1,dec_net2,dec_net4,dec_net5,mse_loss,gamma,Nstate,primary_udim1,primary_udim2)
#                 Eloss = Eig_loss(net)
#                 loss = Kloss
...
#     parser.add_argument("--env", type=str, default="transfer_learning")
#     parser.add_argument("--suffix", type=str, default="test15")
#     parser.add_argument("--K_train_samples", type=int, default=50000)
#     parser.add_argument("--e_loss", type=int, default=1)
#     parser.add_argument("--gamma", type=float, default=0.8)
#     parser.add_argument("--encode_dim", type=int, default=80)
